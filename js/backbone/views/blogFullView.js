var blogFullView = Marionette.ItemView.extend({
  template: _.template('<h1><%- titulo %></h1> \
  	          <p><%- contenido %></p> \
              ...
              <div id="form-comments-container col-lg-12"> \
              <form class="form-horizontal well bs-component col-lg-12" id="form-blog"> \
                <fieldset> \
                  <div class="form-group"> \
                    ...
                    <div class="form-group"> \
                      <div class="col-lg-6 col-lg-offset-6"> \
                        <a class="btn btn-primary addComment col-lg-5 col-lg-offset-1" href="javascript:;">Crear</a> \
                      </div> \
                    </div> \
                </fieldset> \
              </form> \ 
